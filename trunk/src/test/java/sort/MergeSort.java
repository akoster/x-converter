...
public class MergeSort {
    ...
    private void sortArray(int low, int high) {
        ...
        if ((high - low) >= 1) // if not base case
        {
            ...
            System.out.println("Sorting left half: " + subarray(low, middle1));
            sortArray(low, middle1); // first half of array
            System.out.println("Sorting right half: " + subarray(middle2, high));
            sortArray(middle2, high); // second half of array

            // merge two sorted arrays after split calls return
            merge(low, middle1, middle2, high);
        } // end if
        System.out.println("Completed sortArray for " + subarray(low, high));
    } // end method split
